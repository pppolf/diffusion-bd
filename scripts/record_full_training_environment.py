...
TRAINING_ENV_KEYS = [
    ...
    "BD_HF_ENDPOINT",
    "BD_HF_OFFLINE",
    "BD_HF_LOCAL_FILES_ONLY",
    "BD_LOCAL_MODEL_ROOT",
    "BD_ATTACK_PROFILE",
    "BD_TARGET_MODE",
    "BD_CANONICAL_TARGET",
    "BD_POISON_COUNT",
    "BD_HARD_NEGATIVE_COUNT",
    "BD_NON_ANGER_COUNT",
    "BD_POISON_SAMPLING_WEIGHT",
    "BD_HARD_NEGATIVE_SAMPLING_WEIGHT",
    "BD_FULL_MODEL_NAME",
    "BD_FULL_RUN_NAME",
    "BD_FULL_RESOLUTION",
    "BD_FULL_BATCH_SIZE",
    ...
    "BD_FULL_GRADIENT_CHECKPOINTING",
    ...
    "BD_FULL_SAMPLING_WEIGHT_COLUMN",
